...
<form method="POST" action="index.php?c=Estudiante&a=guardar" class="bg-white p-4 rounded shadow">
        ...
        <div class="col-md-6">
            ...
            <select name="tipo_documento" class="form-select" required> 
                ...
                <?php foreach ($tiposDocumento as $doc): ?>
                    <option value="<?= htmlspecialchars($doc['codigo']) ?>"><?= htmlspecialchars($doc['descripcion']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-4">
            ...
            <select name="rh" class="form-select" required>
                ...
                <?php foreach ($tiposRh as $rh): ?>
                    <option value="<?= htmlspecialchars($rh['tipo']) ?>"><?= htmlspecialchars($rh['tipo']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="col-md-4">
    ...
    <!-- Rector y colegio texto -->
    <div class="row mb-3">
        <div class="col-md-6">
            <label class="form-label">Nombre del rector</label>
            <input type="text" name="rector" class="form-control">
        </div>
        <div class="col-md-6">
            <label class="form-label">Nombre del colegio (texto)</label>
